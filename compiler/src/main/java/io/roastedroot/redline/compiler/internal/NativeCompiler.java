...
public final class NativeCompiler {
    ...
    private final RedlineBridge bridge;
    ...
    private NativeCompiler(RedlineBridge bridge, String triple, WasmModule module) {
        this.bridge = bridge;
        this.triple = triple;
        this.module = module;
        this.numImports =
    ...
    public byte[][] compileAll(boolean[] filter) {
        ...
        for (int t = 0; t < threads; t++) {
            ...
            futures.add(
                    POOL.submit(
                            () -> {
                                try (var threadBridge = new RedlineBridge()) {
    ...
    private byte[] compileFunction(int bodyIndex) {
        ...
        bridge.exports().addParamType(RedlineBridge.TYPE_I64); // memBase
        bridge.exports().addParamType(RedlineBridge.TYPE_I64); // ctxPtr
        ...
        if (multiReturn) {
            ...
            bridge.exports().addReturnType(RedlineBridge.TYPE_I64);
        } else {
        ...
        int memBaseVar = bridge.exports().declareVar(RedlineBridge.TYPE_I64);
        bridge.exports().defVar(memBaseVar, memBaseParam);
        int ctxPtrVar = bridge.exports().declareVar(RedlineBridge.TYPE_I64);
        ...
        switch (ins.opcode()) {
            ...
            case I32_TRUNC_F32_S:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I32, RedlineBridge.TYPE_F32, true);
                break;
            case I32_TRUNC_F32_U:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I32, RedlineBridge.TYPE_F32, false);
                break;
            case I32_TRUNC_F64_S:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I32, RedlineBridge.TYPE_F64, true);
                break;
            case I32_TRUNC_F64_U:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I32, RedlineBridge.TYPE_F64, false);
                break;
            case I64_TRUNC_F32_S:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I64, RedlineBridge.TYPE_F32, true);
                break;
            case I64_TRUNC_F32_U:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I64, RedlineBridge.TYPE_F32, false);
                break;
            case I64_TRUNC_F64_S:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I64, RedlineBridge.TYPE_F64, true);
                break;
            case I64_TRUNC_F64_U:
                NativeEmitters.emitSafeTrunc(
                        ctx, RedlineBridge.TYPE_I64, RedlineBridge.TYPE_F64, false);
                break;

            case I32_TRUNC_SAT_F32_S:
                NativeEmitters.emitTruncSat(ctx, RedlineBridge.TYPE_I32, true);
                break;
            case I32_TRUNC_SAT_F32_U:
                NativeEmitters.emitTruncSat(ctx, RedlineBridge.TYPE_I32, false);
                break;
            ...
            case I64_TRUNC_SAT_F32_S:
                NativeEmitters.emitTruncSat(ctx, RedlineBridge.TYPE_I64, true);
                break;
            case I64_TRUNC_SAT_F32_U:
                NativeEmitters.emitTruncSat(ctx, RedlineBridge.TYPE_I64, false);
                break;
            ...
            case F32_CONVERT_I32_S:
                NativeEmitters.emitConvertFloat(ctx, RedlineBridge.TYPE_F32, true);
                break;
            case F32_CONVERT_I32_U:
                NativeEmitters.emitConvertFloat(ctx, RedlineBridge.TYPE_F32, false);
                break;
            ...
            case F64_CONVERT_I32_S:
                NativeEmitters.emitConvertFloat(ctx, RedlineBridge.TYPE_F64, true);
                break;
            case F64_CONVERT_I32_U:
                NativeEmitters.emitConvertFloat(ctx, RedlineBridge.TYPE_F64, false);
                break;
