...
final class EmitContext {
    ...
    int getOrCreateSigRef(FunctionType ft) {
        ...
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64); // memBase
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64); // ctxPtr
    ...
    int getOrCreateMultiReturnSigRef(FunctionType ft) {
        ...
        bridge.exports().sigAddReturn(RedlineBridge.TYPE_I64);
        int sigRef = bridge.exports().endSig();
        sigRefCache.put(key, sigRef);
        return sigRef;
    }
    ...
    int getOrCreateTrampolineSigRef() {
        ...
        bridge.exports().beginSig();
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64);
        bridge.exports().sigAddReturn(RedlineBridge.TYPE_I64);
        int sigRef = bridge.exports().endSig();
        sigRefCache.put(key, sigRef);
        return sigRef;
    ...
    int getOrCreateMemopSigRef() {
        ...
        bridge.exports().beginSig();
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64); // dst ptr
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64); // src ptr / value
        bridge.exports().sigAddParam(RedlineBridge.TYPE_I64); // size
        bridge.exports().sigAddReturn(RedlineBridge.TYPE_I64);
        int sigRef = bridge.exports().endSig();
        sigRefCache.put(key, sigRef);
        return sigRef;
