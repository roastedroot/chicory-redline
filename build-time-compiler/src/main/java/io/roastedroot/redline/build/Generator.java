package io.roastedroot.redline.build;
...
import io.roastedroot.redline.api.NativeCodeSerializer;
...
public class Generator {
    ...
    private static void compileForTarget(
        ...
        var suffix = RedlineTarget.resourceSuffix(triple);
    ...
    public void generateModuleInterface() throws IOException {
        ...
        var codegen =
                ModuleInterfaceCodegen.builder(module)
                        ...
                        .withGeneratorName("io.roastedroot.redline.build.Generator")
                        .build();
    ...
    private String generateSourceCode(String packageName, String baseName) {
        ...
        cu.addImport(RedlineTarget.class);
        cu.addImport(NativeCodeSerializer.class);
        cu.addImport("io.roastedroot.redline.api.RedlineInstance");
    ...
    private static void generateNativeCodeHolderInnerClass(
        ...
        // String host = RedlineTarget.detectHost();
        var detectHost = new MethodCallExpr(new NameExpr("RedlineTarget"), "detectHost");
        var hostDecl =
                new VariableDeclarationExpr(
                        new com.github.javaparser.ast.body.VariableDeclarator(
                                parseType("String"), "host", detectHost));

        // String suffix = RedlineTarget.resourceSuffix(host);
        var suffixInit =
                new MethodCallExpr(
                        new NameExpr("RedlineTarget"),
                        "resourceSuffix",
    ...
    private static void generateUniversalBuilderMethod(
        ...
        cu.addImport("io.roastedroot.redline.UniversalInstance");
        ...
        var method =
                type.addMethod("builder", Modifier.Keyword.PUBLIC, Modifier.Keyword.STATIC)
                        .setType(parseClassOrInterfaceType("RedlineInstance.Builder"));
        method.setJavadocComment(
                "Creates a builder that automatically selects the best available backend:\n"
                        + "Redline native code when a runner is on the classpath, or\n"
                        + "Chicory JVM bytecode otherwise. Use {@code .build()} to obtain\n"
                        + "a {@link RedlineInstance} and call\n"
                        + "{@link RedlineInstance#isNative()} to check which backend\n"
                        + "was selected.");
    ...
    private static void generateBuilderMethod(ClassOrInterfaceDeclaration type) {
        ...
        var method =
                type.addMethod("builder", Modifier.Keyword.PUBLIC, Modifier.Keyword.STATIC)
                        .setType(parseClassOrInterfaceType("RedlineInstance.Builder"));
        method.setJavadocComment(
                "Creates a builder backed by Redline native code.\n"
